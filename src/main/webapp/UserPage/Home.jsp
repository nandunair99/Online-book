...
<body>
		...
		<div class="grids-main py-5">
			<div class="container py-lg-3">
				...
				<div class="w3l-populohny-grids">
					...
					<c:forEach var="upMovie" items="${AllMovieData}">
						<c:if test="${upMovie.getStatus() eq 2}">
						<a href="ExploreMovieServlet?MovieId=${upMovie.getMovieID()}">
						<div class="item vhny-grid" style="cursor: pointer;">
							<div class="box16">
									<figure>
										<img class="img-fluid" style="height:350px;width:270px;object-fit: cover" src="data:image/png;base64,${upimgPoster.get(i)}" alt="">
									</figure>
									<div class="box-content">
										<h3 class="title">${upMovie.getMovieTitle()}</h3>
										<h4> <span class="post"><span class="fa fa-calendar"></span> &nbsp;&nbsp;<fmt:formatDate dateStyle = "medium" timeStyle = "medium" value = "${upMovie.getReleaseDate()}" />
											</span>
	...
	<!--grids-sec2-->
	<section class="w3l-grids">
		<div class="grids-main py-5" style="margin-top: -84px">
			<div class="container py-lg-3">
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						<div class="headerhny-left">
							<h3 class="hny-title">In Cinemas</h3>
						</div>
						<div class="headerhny-right text-lg-right">
							<h4><a class="show-title" href="genre.html">Show all</a></h4>
						</div>
				...
				<div class="owl-three owl-carousel owl-theme">
					...
					<c:forEach var="movie" items="${MovieData}">
						<div class="item vhny-grid">
							<a href="ExploreMovieServlet?MovieId=${movie.getMovieID()}">
							<div class="box16 mb-0">
									<figure>
										<img style="height:300px;width:220px" class="img-fluid" src="data:image/png;base64,${imgPoster.get(i)}" alt="">
									</figure>
									<div class="box-content">
										<h4> <span class="post"><span class="fa fa-clock-o"></span>
											${movie.getDuration()} hrs.										 
											</span>
											<span class="post fa fa-heart text-right"></span>
										</h4>
									</div>
							...
							<h3> <a class="title-gd" href="genre.html">${movie.getMovieTitle()}</a></h3>
							<p>${movie.getCensorRating()}<br>
							<c:forEach var="language" items="${movie.getLanguage()}">
								${language.getLanguage()} 
							</c:forEach>
							</p>
							<div class="button-center text-center mt-4">
								<a href="genre.html" class="btn watch-button">Book tickets</a>
							</div>
						</div>
						<c:set var="i" value="${i + 1}" scope="page" />
					</c:forEach>
